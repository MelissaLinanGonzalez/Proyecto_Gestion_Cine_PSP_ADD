        ...
        <div className="min-h-screen bg-[#020b14] pb-20 overflow-x-hidden font-sans text-blue-100">
            ...
            <div className={`relative z-40 px-6 md:px-16 space-y-4 transition-all duration-500 ${searchTerm || selectedCat ? 'pt-32' : '-mt-16'}`}>
                {(searchTerm || selectedCat) && (
                    <h2 className="text-2xl font-bold text-white mb-6 pl-2 border-l-4 border-[#0066FF] flex items-center gap-3 animate-fade-in">
            ...
            {searchTerm || selectedCat ? (
                ...
                <>
                    {/* Hero Section */}
                    <div className="relative h-[60vh] md:h-[85vh] w-full group overflow-hidden bg-black -mt-32">
                        {featuredVideo ? (
